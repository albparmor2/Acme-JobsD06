...
<acme:form readonly="true">
	...
	<acme:form-textbox code="anonymous.company-record.form.label.contactPhone" path="contactPhone"/>
	<acme:form-textbox code="anonymous.company-record.form.label.contactEmail" path="contactEmail"/>
