...
@Service
public class AuditorAuditRecordUpdatePublishService implements AbstractUpdateService<Auditor, AuditRecord> {
	...
	public void bind(final Request<AuditRecord> request, final AuditRecord entity, final Errors errors) {
		...
		request.bind(entity, errors, "creation", "status", "title", "body");
