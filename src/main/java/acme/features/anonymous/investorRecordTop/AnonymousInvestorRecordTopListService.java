...
@Service
public class AnonymousInvestorRecordTopListService implements AbstractListService<Anonymous, InvestorRecord> {

	@Autowired
	AnonymousInvestorRecordTopRepository repository;
