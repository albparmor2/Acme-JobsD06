...
@Service
public class AdministratorAuditorRequestUpdateAcceptedService implements AbstractUpdateService<Administrator, AuditorRequest> {
	...
	public void update(final Request<AuditorRequest> request, final AuditorRequest entity) {
		...
		a.setUserAccount(entity.getAuthenticated().getUserAccount());
